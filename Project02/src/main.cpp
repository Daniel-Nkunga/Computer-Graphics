...
void init() {
  ...
  ghosts.push_back(
      Ghost({-0.25f, -0.25f, 0.0f}, 0.0625f, {255.0f, 0.0f, 0.0f})); // Blinky
  ghosts.push_back(
      Ghost({-0.25f, 0.25f, 0.0f}, 0.0625f, {255.0f, 184.0f, 255.0f})); // Pinky
  ghosts.push_back(
      Ghost({0.25f, 0.25f, 0.0f}, 0.0625f, {0.0f, 255.0f, 255.0f})); // Inky
  ghosts.push_back(
      Ghost({0.25f, -0.25f, 0.0f}, 0.0625f, {255.0f, 184.0f, 82.0f})); // Clide
