...
void Pellet::setPosition(std::tuple<float, float, float> position) {
  this->position = position;
}
void Pellet::setRadius(float radius) { this->radius = radius; }
void Pellet::setColor(std::tuple<float, float, float> color) {
  this->color = color;
}

// ── Getters ──────────────────────────────────

std::tuple<float, float, float> Pellet::getPosition() const {
